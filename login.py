...
def img_check(i = 0):
    ...
    for result in results["words_result"]:
        ...
        if len(text) == 4:
            ...
            browser.find_element("xpath", '//*[@id="fm1"]/ul/li[5]/button').click()  # 提交按钮查看按钮元素，click模拟点击提交
...
if __name__ == '__main__':
    ...
    # chrome_options.add_argument('window-size=1920x1025')
    ...
    browser.quit()
    # # 指定源文件路径
    source_file = "/mnt/c/Users/Yoruko/Downloads/"

    # # 指定目标文件夹路径
    os.system("mkdir -p /mnt/g/Homework/16th4C/py/" + USER_NAME)
    target_folder = "/mnt/g/Homework/16th4C/py/" + USER_NAME
